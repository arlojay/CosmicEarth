...
public class YellowBirchTreeStructure extends WorldgenStructure {
    static BlockState treeLogBlock = getBlockStateInstance("cosmicearth:birch_log[default]");
    static BlockState leavesBlock = getBlockStateInstance("cosmicearth:yellow_birch_leaves[default]");
    ...
    public void generate(Random random, Zone zone, int globalX, int globalY, int globalZ) {
        int treeHeight = random.nextInt(10, 13);
